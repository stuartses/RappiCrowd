...
import LogginSolicitante from '../pages/LoginSolicitante';
import LogginInversor from '../pages/LoginInversor';
        ...
        <BrowserRouter>
          <Layout>
            <Switch>
              ...
              <Route exact path='/login-inversor' component={LogginInversor}></Route>
              <Route exact path='/registro-domiciliario' component={RegistroDomiciliario}></Route>
              <Route exact path='/login-solicitante' component={LogginSolicitante}></Route>
