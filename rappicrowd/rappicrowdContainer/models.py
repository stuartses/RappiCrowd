...
class Workers(models.Model):
    ...
    workerCreatedAt = models.DateTimeField(default=timezone.now)
    workerUpdatedAt = models.DateTimeField(default=timezone.now)
...
class Investors(models.Model):
    ...
    investorCedCoutryId = models.ForeignKey(Countries, on_delete=models.CASCADE)
    investorStateId = models.ForeignKey(States, on_delete=models.CASCADE)
    investorCreatedAt = models.DateTimeField(default=timezone.now)
    investorUpdatedAt = models.DateTimeField(default=timezone.now)
...
class InvestorsPerWorkers(models.Model):
    ...
    investorPerWorkerCreatedAt = models.DateTimeField(default=timezone.now)
    investorPerWorkerUpdatedAt = models.DateTimeField(default=timezone.now)
